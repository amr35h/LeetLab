...
-- CreateIndex
CREATE UNIQUE INDEX "Problem_email_key" ON "Problem"("email");

-- CreateIndex
CREATE INDEX "TestCaseResult_sumissionId_idx" ON "TestCaseResult"("sumissionId");
...
-- AddForeignKey
ALTER TABLE "TestCaseResult" ADD CONSTRAINT "TestCaseResult_sumissionId_fkey" FOREIGN KEY ("sumissionId") REFERENCES "Submission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
